# Robot Reel 0.14.0 — choose an offline lab
...
| `robot_reel-0.14.0-py3-none-any.whl` | Optional Python installation for independent checks and exports |
...
python -m pip install ./robot_reel-0.14.0-py3-none-any.whl
...
```powershell
py -3.12 -m venv .venv
.\.venv\Scripts\python.exe -m pip install .\robot_reel-0.14.0-py3-none-any.whl
